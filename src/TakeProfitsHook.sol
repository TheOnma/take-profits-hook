...
contract TakeProfitsHook is BaseHook, ERC1155 {
    // StateLibrary is used to add helper functions to the PoolManager to read storage values.
    ...
    // pendingOrders[poolKey.toId()][tickToSellAt][zeroForOne] = inputTokensAmount
